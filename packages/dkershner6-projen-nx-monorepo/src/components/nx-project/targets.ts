...
class TargetFileset {
    ...
    static resolveInputs(values: (string | TargetFileset)[]): string[] {
        return values.map((v) =>
            typeof v === "string" ? v : v.filesetStarIfDir,
        );
    }
